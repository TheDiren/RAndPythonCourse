...
ax.set_ylim(0, 40)
```
The standard plotting of pandas is rather limited. To do the plot shown under *R*, you need to use [Matplotlib](https://matplotlib.org/stable/users/explain/quick_start.html). 

![](images/python_standard_plot.png)


:::


## R: ggplot and Python: Matplotlib
